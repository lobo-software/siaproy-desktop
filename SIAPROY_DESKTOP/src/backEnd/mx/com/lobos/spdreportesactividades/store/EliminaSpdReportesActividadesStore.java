 ...
 * |LOBO SOFTWARE, S.A. DE C.V.                                                                                |  
 * |_______________________________________________________________________|  
 *  Document     : EliminaSpdReportesActividadesStore.java
 * Created on    : 26 Apr 2016 11:34:16 AM
 * Author           : SVA
 * Modifications : 
 */
 ...
 */
public class EliminaSpdReportesActividadesStore {
    ...
    public void eliminaActividades(HashMap<String, Object> parametrosHsm) throws Exception {
        try {
            ...
            sras.eliminaActividades(parametrosHsm);
        } catch (Exception ex) {
            GeneraCuadroMensaje.error(ex.toString() + "\nCLASE: EliminaSpdReportesActividadesStore. \nMÉTODO: eliminaActividades");
        }
    }
}
